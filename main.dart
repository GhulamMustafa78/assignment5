...
void main(){
// print("\nTask 1\n");
// List str = ["Hello","Zabtech","welcome", "to","the","Tech","World"];
// print(str);
// print("\nTask 2\n");
// List mix = ["One","Two","Three",4,5,4.5,true,false];
// print(mix);
// print("\nTask 3\n");
// List edu = ["SSC", "HSC", "BCS", "BS", "BCOM", "MS","M.Phil", "PhD"];
// print(edu);
// print("\nTask 4\n");
// List stu = ["noman","mujiz","ghulam"];
// print(stu);
// int totalmarks = 500;
// stdout.write("Enter Your Name : ");
// String stName = stdin.readLineSync()!;
// if(stName == "noman"||stName == "ghulam"||stName == "mujiz"){
...
// }
// print("\nTask 5\n");
// List stuScore = [434,321,430,530];
// print(stuScore);
// stuScore.sort();
// print ("Asending : ${stuScore}");
// print("\nTask 6\n");
// print ("Desending : ${stuScore.reversed.toList()}");
// print("\nTask 7\n");
// List pLang=["Python","Java","c++","c","Dart"];
// var ind = pLang.getRange(2,4).toList();
// print("Inde for 2 to 3 : ${ind}");
// print("\nTask 8\n");
